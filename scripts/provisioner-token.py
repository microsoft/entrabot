...
CertificateCredential (via entra_provisioning.get_existing_graph_token) which
...
from entra_provisioning import ProvisionerBootstrapError, get_existing_graph_token
...
def main() -> int:
    try:
        ...
        #
        # Redirect get_existing_graph_token's diagnostic prints to stderr so the
