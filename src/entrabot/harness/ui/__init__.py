...
class UI(Protocol):
    ...
    async def edit_permissions(self, categories: "List[Tuple[str, str]]", state: dict) -> "Optional[dict]": ...
    async def edit_users(self, rows: list[dict]) -> dict | None: ...
    async def form(self, title: str, fields: "List[dict]") -> "Optional[dict]": ...
    async def run(
        self,
