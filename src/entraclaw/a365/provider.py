...
from entraclaw.a365.catalog import get_server
from entraclaw.a365.manifest import load_manifest
from entraclaw.a365.mcp_client import WorkIqMcpClient
from entraclaw.a365.tokens import (
    A365TokenProvider,
    EntraclawA365TokenProvider,
    WorkIqTokenRequest,
)
...
class WorkIqProvider:
    ...
    def __init__(
        ...
        *,
        ...
        self._token_provider = token_provider or EntraclawA365TokenProvider()
