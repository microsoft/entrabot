...
- [ ] Entra app registration created for Entrabot agent
...
2. Click "Add a scope":
   ...
   - Admin consent display name: "Access Entrabot as user"
   - Admin consent description: "Allows the Entrabot agent to act on behalf of the signed-in user"
   - State: Enabled
